...
export function Footer() {
  ...
  return (
    <footer className="container-site pb-10 pt-20 md:pt-28">
      <div className="flex flex-col items-center text-center">
        <ScrollReveal>
          <motion.h2
            className="text-[48px] leading-[1.05] tracking-tight md:text-[84px] md:leading-none lg:text-[140px]"
      ...
      <ScrollReveal delay={0.08} className="mt-16 md:mt-24">
